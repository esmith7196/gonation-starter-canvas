...
const PoweredBy = ({ fillColor }) => {
  return (
    <svg version='1.1' x='0px' y='0px' viewBox='0 0 250 25'>
      <g>
        <path fill={fillColor} d='M1,6.4h1.5v10.6h5.1v1.3H1V6.4z' />
        <path
          fill={fillColor}
        ...
        />
        <path fill={fillColor} d='M35.3,5.8h1.6v12.6h-1.6V5.8z' />
        <path
          fill={fillColor}
